...
#基础参数
my_text = {'text':u'test','x':0,'y':0,'y_mov':0,'size':0,'rot':0,'c_rot':0}
...
dot_x,dot_y 圆点坐标
'''
def RStart(obj,dot_x,dot_y,dire=1):
    print('RStart')
    ...
    if obj['rot'] == 0:
        setText(obj,rot=rot_ang,c_rot=rot_ang)
    # setText(c_rot=rot_ang)
    rot = obj['c_rot']+5*t_inc#旋转角度
    ...
    setText(obj=obj,x=x,y=y,c_rot=rot_ang)
'''
更新画布
'''
