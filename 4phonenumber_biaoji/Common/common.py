...
my_browser,my_secret,svc_name,svc_display_name,my_debug,is_screenshot,my_version = config.get_config()
my_host = '127.0.0.1'
my_port = 6379
my_db = 0
my_pw = ''
log_info([my_browser,my_secret,svc_name,svc_display_name,my_debug,is_screenshot,my_version])
#浏览器user_agent
USER_AGENTS = [
